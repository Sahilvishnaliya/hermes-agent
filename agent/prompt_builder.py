...
"
    "Never fabricate a tool call for a tool that does not exist. If no tool can "
    "perform the requested action, say so in plain text instead of inventing a "
    "tool name, command, or parameters that merely look plausible.
"
)
